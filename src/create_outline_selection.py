...
# merge num resposes to languages people used
...
print("Saved Selection template to:", Path("~/Projects/hypocognition/data/processed/outline_selection.csv").expanduser())
