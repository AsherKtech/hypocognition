...
* [`Covid51countries.csv`](https://osf.io/s5puc/files/cemh7): 
    * This is the data from a study focused on the relationship between momentary emotional experiences and psychological well-being during the COVID-19 pandemic. The data was collected across three distinct studies involving a total of 26,263 participants, and we focused on the Global Study
    * Data from 24,221 participants across 51 countries.
    * The survey was provided in 50 languages.
    * We focused on only non-english speaking responses from non-english speaking countries
    * Participants rated the extent to which they experienced 20 specific emotions (10 positive and 10 negative) over the past week on a scale of 0 to 6.* there awas also Well-Being Metrics and Control Variables, but we didn't focus on those.
...
* `Tamir2016data.sav` (available upon request from the authors) :
    * 2,324 university students were surveyed 
    * from 8 countries (United States, Brazil, China, Germany, Ghana, Israel, Poland, and Singapore)
    * Participants reported the emotions they actually felt and the emotions they desired to feel in their daily lives.  
    * Measured overall life satisfaction and depressive symptoms to assess well-being.
    * We focused on only non-english speaking responses from non-english speaking countries
    * We focused on the emotion responses, how much have they felt and how much have they desired to feel the following:
        *  'Gratitude',
        *  'Disappointment',
        *  'Contentment',
        *  'Guilt',
...
#### Corresponding to the Tamir data, the same process was followed:

* [tamir.ipynb](notebooks/tamir.ipynb): We only produced the results in a notebooks. No pipeline.
